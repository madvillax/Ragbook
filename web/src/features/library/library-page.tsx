...
function BookCard({ book, index }: { book: Book; index: number }) {
  ...
  return (
    ...
    >
      <Link href={`/books/${book.id}`} className="block rounded-2xl focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-500">
...
export function LibraryPage() {
  ...
  const libraryIsEmpty = !documents.isPending && !documents.error && documents.data.length === 0;
        ...
        <main className="mx-auto max-w-[1500px] px-4 pb-16 pt-8 sm:px-7 lg:px-10 lg:pt-10">
          ...
          <section className="mt-11">
            ...
            <div className="mt-5">
              ...
              {!documents.isPending && !documents.error && filtered.length > 0 ? (
